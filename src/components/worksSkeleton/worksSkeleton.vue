...
<<<<<<< HEAD
	...
	.loading .work-author-box .work-avatar {
		...
		background: linear-gradient(100deg, rgba(255, 255, 255, 0) 40%, rgba(255, 255, 255, 0.5) 50%, rgba(255, 255, 255, 0) 60%) $uni-text-color-grey;
...
>>>>>>> 1ac7f9078b98b96833fc51e51121dbdfc4013a0b
</style>
