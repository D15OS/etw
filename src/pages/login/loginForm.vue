<template>
    <!-- 登录表单 -->
    <view class="login-form" :class="loginFormAnimation" :style="{display: showLoginForm}">
        <text class="title">登 录</text>
        <!-- S 输入框区域 -->
        <view class="input-area">
            <view class="username-container" :class="usernameContainerStyle">
                <view class="input-placeholder" :class="usernamePlaceholderStyle">电子邮箱 / 手机</view>
                <input type="text" class="username-input" v-model="username" :focus="usernameFocusState"
