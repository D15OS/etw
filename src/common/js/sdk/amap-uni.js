...
AmapUni.prototype.getWxLocation = function (a, b) {
	uni.getLocation({
...
}, AmapUni.prototype.getRegeo = function (a) {
	function c(c) {
...
}, AmapUni.prototype.getWeather = function (a) {
	function d(d) {
		var e = "base";
...
}, AmapUni.prototype.getPoiAround = function (a) {
	function d(d) {
		var e = {
			key: b.key,
			location: d,
...
}, AmapUni.prototype.getStaticmap = function (a) {
	function f(b) {
...
}, AmapUni.prototype.getInputtips = function (a) {
...
}, AmapUni.prototype.getDrivingRoute = function (a) {
	var b = this, c = b.requestConfig, d = {
		key: b.key,
		s: c.s,
		platform: c.platform,
...
}, AmapUni.prototype.getWalkingRoute = function (a) {
	var b = this, c = b.requestConfig, d = {
		key: b.key,
		s: c.s,
		platform: c.platform,
...
}, AmapUni.prototype.getTransitRoute = function (a) {
	var b = this, c = b.requestConfig, d = {
		key: b.key,
		s: c.s,
		platform: c.platform,
...
}, AmapUni.prototype.getRidingRoute = function (a) {
	var b = this, c = b.requestConfig, d = {
		key: b.key,
		s: c.s,
		platform: c.platform,
